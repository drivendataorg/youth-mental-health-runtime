...
IMAGE_NAME = cdc-narratives-competition
OFFICIAL_IMAGE = cdcnarratives.azurecr.io/${IMAGE_NAME}
...
# 2. Local image, e.g., cdc-narratives-competition:gpu-local
# 3. Official competition image, e.g., cdcnarratives.azurecr.io/cdc-narratives-competition
